...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "nikhilballari123@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("nikhilballari1234@gmail.com", 'nikhil@@2002') # Senders mail ID and password
        server.sendmail('nikhilballari123@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
